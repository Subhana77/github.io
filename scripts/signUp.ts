...
function initializeSignupForm(): void {
    ...
    const newForm = signupForm.cloneNode(true) as HTMLFormElement;
    signupForm.parentNode!.replaceChild(newForm, signupForm);

    newForm.addEventListener('submit', function (e: Event) {
        console.log('Form submit event triggered');
        e.preventDefault();

        const nameInput = this.querySelector('#name') as HTMLInputElement | null;
        const emailInput = this.querySelector('#email') as HTMLInputElement | null;
        const preferredRoleInput = this.querySelector('#preferredRole') as HTMLSelectElement | null;
        ...
        try {
            ...
            console.error('Error in form submission:', (error as Error).message);
