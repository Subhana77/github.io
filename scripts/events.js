...
document.addEventListener("DOMContentLoaded", function () {
    const eventsContainer = document.getElementById("eventsContainer"); // Get the container where events will be displayed
    const eventTypeFilter = document.getElementById("eventType"); // Get the event type filter dropdown
    const eventLocationFilter = document.getElementById("eventLocation"); // Get the event location filter dropdown
    const eventDateFilter = document.getElementById("eventDate"); // Get the event date filter input field

    let eventsData = []; // Initialize an empty array to hold events data
